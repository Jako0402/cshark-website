...
let categoryButtons = document.getElementById("subNavBarButtons").querySelectorAll(".CategoryButton");


let card = document.querySelector("#card");
let showingAwnser = getComputedStyle(card).getPropertyValue("--showingAwnser");
